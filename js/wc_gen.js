...
let wcGenTextHandler = function(wc_gen_button, input_text_element, output_image) {
  return function() {
...
let wcGenFileHandler = function(wc_gen_button, input_file_element, output_image) {
  return function() {
...
languagePluginLoader.then(() => {
  ...
  wc_gen_text_button.onclick = wcGenTextHandler(wc_gen_text_button, input_text_element, output_text_image);
  ...
  wc_gen_file_button.onclick = wcGenFileHandler(wc_gen_file_button, input_file_element, output_file_image);
